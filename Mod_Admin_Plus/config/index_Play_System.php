...
function show_ficha(){
	...
	global $vname; 		$tabla1 = $_SESSION['clave'].$_SESSION['ref'];
	...
	if($count1 < 1){
		...
		global $din; 	global $tin; 	$din = date('Y-m-d');
	...
	<form name='form_datos' method='post' action='fichar/fichar_Crear.php'>
...
////////////////////				////////////////////				////////////////////
	...
	<embed src='audi/salida.mp3' autostart='true' loop='false' width='0' height='0' hidden='true' ></embed>
	</table>";	
