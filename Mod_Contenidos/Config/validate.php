...
if (preg_match('/^(\w{1})*(\s\w{1})/',$_POST['Apellidos'],$ref4)){	$rf4 = $ref4[2];
	...
	/* COMPROBAMOS SI EXISTE EL ADMINISTRADOR */
		...
		$admin =  "SELECT * FROM `$db_name`.$tablename WHERE `ref` = '$rf'";
...
////////////////////				////////////////////				////////////////////
	...
	global $tablename;	$tablename = "`".$_SESSION['clave']."admin`";
	$sqldni =  "SELECT * FROM `$db_name`.$tablename WHERE $tablename.`dni` = '$_POST[dni]'";
...
////////////////////				////////////////////				////////////////////
	...
	/* VALIDAMOS LA LETRA DE CONTROL DE NIE EXTRANJEROS NORMAL Y ESPECIALES */
		...
		/* DEFINO EL ALGORITMO PARA EL CALCULO DE LA LETRA CONTROL DEL NIE/NIF ESPECIAL */
			...
			global $num4;	global $num5;	global $num6;	global $num7;
		if(strlen(@trim($_POST['dni'])) != 0){
			global $dni3;
			$dni3 = $_POST['dni'];
			
			$num1 = (int) $dni3[1];			$num2 = (int) $dni3[2];
			$num3 = (int) $dni3[3];			$num4 = (int) $dni3[4];
			$num5 = (int) $dni3[5];			$num6 = (int) $dni3[6];
			$num7 = (int) $dni3[7];
...
////////////////////				////////////////////				////////////////////
	...
	global $tablename;	$tablename = "`".$_SESSION['clave']."admin`";
	$sqlml =  "SELECT * FROM `$db_name`.$tablename WHERE $tablename.`Email` = '$_POST[Email]'";
...
////////////////////				////////////////////				////////////////////
	...
	global $db; 	global $sqlus;
	global $qus; 	global $db_name;

	global $tablename;	$tablename = "`".$_SESSION['clave']."admin`";
	$sqlus =  "SELECT * FROM `$db_name`.$tablename WHERE $tablename.`Usuario` = '$_POST[Usuario]'";
...
////////////////////				////////////////////				////////////////////
	...
	global $tablename;	$tablename = "`".$_SESSION['clave']."admin`";
	$sqltlf1 =  "SELECT * FROM `$db_name`.$tablename WHERE $tablename.`Tlf1` = '$_POST[Tlf1]' OR $tablename.`Tlf2` = '$_POST[Tlf1]' ";
...
////////////////////				////////////////////				////////////////////
	...
	global $tablename;	$tablename = "`".$_SESSION['clave']."admin`";
	$sqltlf2 =  "SELECT * FROM `$db_name`.$tablename WHERE $tablename.`Tlf1` = '$_POST[Tlf2]' OR $tablename.`Tlf2` = '$_POST[Tlf2]'";
